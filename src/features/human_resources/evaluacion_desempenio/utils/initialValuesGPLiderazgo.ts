...
export const initialValueGrupoPrimLiderazgo = {
  id_grupo_evaluacion: GrupoEvaluacion.GrupoPrimario,
  id_evaluador: 0,
  id_evaluado: 0,
  id_enfoque_evaluacion: EnfoqueEvaluacion.Liderazgo,
  observaciones: "",
  preguntas: [
    ...
    {
      pregunta: "Promueve el desarrollo y el aprendizaje continuo de su equipo",
      calificacion: "",
      fecha: "",
      id_adn: ADNDeliflor.ElQueSabe,
    },
